...
import { useRealtimeAuction, useOnlineParticipants } from "../../hooks";
...
const RealtimeAuctionCard = ({
  ...
  const realtimeAuction = useRealtimeAuction(auction.id, rawAuction);
  ...
  const totalBids = realtimeAuction.bids?.length || auction.totalBids || 0;
  const watchers = onlineCount || auction.watchers || 0;
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200">
            ...
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span
                className={
                  watchers > auction.watchers ? "text-blue-600 font-bold" : ""
                }
              >
                {watchers} watching
              </span>
          ...
          {realtimeAuction.bids && realtimeAuction.bids.length > 0 && (
            <div className="mt-2 pt-2 border-t border-gray-200">
              <div className="text-xs text-green-600 flex items-center">
                ...
                Last bid: {realtimeAuction.bids[0]?.userName} - ₨
                {realtimeAuction.bids[0]?.amount.toLocaleString()}
              </div>
            </div>
          )}
        </div>
